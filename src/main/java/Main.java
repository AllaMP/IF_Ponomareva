...
public class Main {
    public static void main(String[] args) {
        ...
        cars.add(new Car.Suzuki("Swift", 2000, "Blue", 105, 120000, 1.2, 95));
        cars.add(new Car.Toyota("Corolla", 2010, "Green", 150, 95000, 1.8, 92));
        cars.add(new Car.Ford("Focus", 2007, "Red", 120, 110000, 2.0, 92));
        cars.add(new Car.BMW("X5", 2015, "Black", 200, 60000, 3.0, 95));
        cars.add(new Car.Audi("A4", 2008, "Green", 180, 80000, 2.0, 95));
        cars.add(new Car.Suzuki("Vitara", 2018, "White", 170, 40000, 1.6, 95));
        cars.add(new Car.Toyota("Camry", 2012, "Silver", 200, 70000, 2.5, 95));
        cars.add(new Car.Ford("Mustang", 2019, "Yellow", 466, 20000, 5.0, 100));
        cars.add(new Car.BMW("320i", 2005, "Silver", 200, 90000, 2.0, 95));
        cars.add(new Car.Audi("Q7", 2017, "Gold", 200, 50000, 3.0, 95));
